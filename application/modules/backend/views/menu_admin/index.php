<div class="card shadow radius-10">
    <div class="card-header bg-light">
        <div class="row">
            <div class="col-md-6">
                <button type="button" id="btn_add" class="btn btn-primary btn-block btn-sm"><i
                        class="bx bx-plus-circle"></i> Tambah Data</button>
                <button type="button" id="btn_reload" class="btn btn-secondary btn-block btn-sm"><i
                        class="bx bx-sync"></i> Refresh Data</button>
            </div>
            <div class="col-md-6">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row mb-2 icon_parent">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <button class="btn btn-primary search_boxicons" type="button"><i
                                    class="bx bx-search-alt"></i> Cari Icon</button>
                            <span class="input-group-text"><i id="icon_boxicons"></i></span>
                            <input type="text" name="icon" class="form-control input_boxicons validate"
                                placeholder="Icon ...">
                        </div>
                    </div>
                </div>
                <div class="form-group row mb-2">
                    ...
                    <div class="col-md-9">
                        <input type="number" min="1" name="position" class="form-control validate"
                            placeholder="Index Urutan / Posisi ...">
                    </div>
                </div>
            </div>
...
function drawTable(v, no, branch, parent, page, indent) {
    ...
    if (no !== '') {
        btn_add = '<button type="button" class="btn btn-primary btn-sm" onclick="addSubMenu(' + v.id + ',' + '\'' + v
            .name + '\'' + ',' + page +
            ')" title="Klik untuk menambah sub menu"><i class="bx bx-plus-circle"></i></button> ';
    }

    if (v.id !== '') {
        btn = '<button type="button" class="btn btn-success btn-sm" onclick="editData(' + v.id + ', ' + page +
            ')" title="Klik untuk menambah mengubah"><i class="bx bx-edit"></i></button> ' +
            '<button type="button" class="btn btn-danger btn-sm" onclick="deleteData(' + v.id + ', ' + page +
            ')" title="Klik untuk menghapus sub menu"><i class="bx bx-trash"></i></button> ';
    }
