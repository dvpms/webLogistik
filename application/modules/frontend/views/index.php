<section class="services">
            ...
            <div class="service-grid">
                <div class="service-card">
                    <div class="icon"><img src="/frond-end/images/truck.svg" alt=""> </div>
                    <div class="content">
                        <a href="service-details-p.html">
                            <h2>Pengiriman Dalam Kota (Reguler)</h2>
                            <p>Pengiriman yang dapat dilatur untuk kota tertentu yang disesuaikan oleh lokasi anda dan dapat dilaksanakan dengan tepat</p>    
                        </a>
                    </div>
                </div>
                <div class="service-card">
