...
<head>
    ...
    <!-- favicon -->
    <link rel="icon" type="image/png" href="public/assets/clouds/drives/brand/logistik.png" sizes="32x32">
    <link rel="icon" type="image/png" href="public/assets/clouds/drives/brand/logistik.png" sizes="16x16">
                        ...
                        <div class="row g-0">
                            <div class="col-lg-12">
                                <div class="box-brand p-lg-0 p-3">
                                    ...
                                    <img src="public/assets/clouds/drives/brand <?php echo $this->brand->logo ?>"
                                        alt="">
                                    <?php endif; ?>
                                ...
                                <div class="p-lg-0 p-3">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="username" autofocus="true" autocomplete="off"
                                                class="form-control-auth form-control" id="username"
                                                placeholder="Enter Username ..."
                                                value="<?php echo set_value('username') ?>">
                                            <small
                                                class="text-danger error"><i><?php echo form_error('username') ?></i></small>
                                        </div>
                                        <div class="mb-1">
                                            <label for="password" class="form-label">Password</label>
                                            <div class="position-relative auth-pass-inputgroup show_hide_password">
                                                <input type="password" name="password" autocomplete="off"
                                                    class="form-control-auth form-control pe-5 password-input"
                                                    id="password" placeholder="Enter Password ...">
                                                <button
                                                    class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted"
                                                    type="button"><b><i
                                                            class="bx bx-hide fs-20 align-middle"></i></b></button>
                                            </div>
                                            <small
                                                class="text-danger error"><i><?php echo form_error('password') ?></i></small>
                                        </div>
