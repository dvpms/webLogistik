...
function syamValidationServer(element, error_string, data) {
  if (data.error_string[error_string]) syamValidation(element, data.error_string[error_string])
}

function syamValidationGroupServer(element, error_string, data) {
  if (data.error_string[error_string]) syamValidationGroup(element, data.error_string[error_string])
}

function syamValidationSelectServer(element, error_string, data) {
  if (data.error_string[error_string]) syamValidationSelect(element, data.error_string[error_string])
}

function syamValidationSelect2Server(element, error_string, data) {
  if (data.error_string[error_string]) syamValidationSelect2(element, data.error_string[error_string])
}
...
function showLoader() {
  $('body').block({
    message: `<div style="margin-top:3px">
                    <img src="${baseUrl}assets/clouds/images/loaders/spinner.gif" width="100" height="100">
                </div>`,
    css: {
      top: '0px',
...
function pleaseWait() {
  return `<div style="margin: auto;border: 0;width: 150px;padding: 4px 10px;text-align:center;">
                <img src="${baseUrl}assets/clouds/images/loaders/spinner.gif" style="margin:0px;auto;" width="100">
